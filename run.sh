...
if [[ $MODE == train ]]; then
	...
	if [[ $DATASET == celebahq_16_128 ]]; then #same as celebahq_256 - might need to revisit later
		...
		python train_srwddgan.py --dataset df2k_128_512 --image_size 512 --exp df2k_128_512_batch2_ts4_atn16_wg112244_d5_recloss_10ep --num_channels 24 \
			...
			--master_port $MASTER_PORT \
			--current_resolution 256 --attn_resolution 16 --num_disc_layers 5 --rec_loss \
			--l_resolution 128 --h_resolution 512 \
